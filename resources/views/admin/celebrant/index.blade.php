                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Фото
                                </th>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Дата
                                    народження</th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Роль
                                </th>
