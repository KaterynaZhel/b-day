                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Прізвище
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Ім'я</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">
                                По-батькові</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Дата
                                народження</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Роль</th>
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-info btn-sm" href="{{route('admin.celebrant.edit', $celebrant->id)}}">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                </a>
                                <form method="post" action="{{route('admin.celebrant.destroy', $celebrant->id)}}">
                                    @method('delete')
                                    @csrf
                ...
                <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
                    <ul class="pagination">
                        <li class="paginate_button page-item previous disabled" id="example1_previous"><a href="#"
                                aria-controls="example1" data-dt-idx="0" tabindex="0" class="page-link">Попередній</a>
                        </li>
                        ...
                        <li class="paginate_button page-item next" id="example1_next"><a href="#"
                                aria-controls="example1" data-dt-idx="7" tabindex="0" class="page-link">Наступний</a>
                        </li>
                    </ul>
                </div>
            </div>
