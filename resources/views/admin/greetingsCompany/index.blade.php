...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div id="greetingCompanies_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                    <div class="col-sm-12">
                        <table id="greetingCompanies" class="table table-bordered table-striped dataTable dtr-inline"
                            aria-describedby="greetingCompanies_info">
                            <thead>
                                <tr class="">
                                    <th class="sorting sorting_asc text-center" tabindex="0"
                                        aria-controls="greetingCompanies" rowspan="1" colspan="1"
                                        aria-sort="ascending">id іменинника</th>
                                    <th class="sorting text-center" tabindex="0" aria-controls="greetingCompanies"
                                        rowspan="1" colspan="1">
                                        Прізвище та ім'я іменинника</th>
                                    <th class="sorting text-center" tabindex="0" aria-controls="greetingCompanies"
                                        rowspan="1" colspan="1">Дата
                                        народження</th>
                                    <th class="sorting text-center" tabindex="0" aria-controls="greetingCompanies"
                                        rowspan="1" colspan="1">Компанія
                                ...
                                @foreach ($greetingsCompany as $greetingCompany)
                                    <tr class="odd">
                                        <td class="dtr-control sorting_1" tabindex="0">
                                            {{ $greetingCompany->celebrant_id }}</td>
                                        <td>{{ $greetingCompany->celebrant->lastname }}&nbsp{{ $greetingCompany->celebrant->firstname }}
                                        </td>
                                        <td>{{ $greetingCompany->celebrant->birthday }}</td>
                                        ...
                                        <td class="project-actions d-flex justify-content-center">
                                            <a class="btn btn-primary btn-sm"
                                                ...
                                                href="{{ route('admin.celebrants.show', $greetingCompany->celebrant_id) }}">
                                                <i class="fas fa-eye">
                                                </i>
                                            </a>
                                        </td>
    ...
    <script type="text/javascript">
        ...
        $("#searchCompany").autocomplete({
            ...
            select: function(event, ui) {
                window.location.href = "{{ route('admin.mainGreetingsCompany.index') }}" + '?search=' + ui.item
                    .label
            }
        });
    </script>
