                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Нагадуємо Вам, що в найближчі 10 днів буде день
                                                                        народження у наступних колег:
                                                                    <ol>
                                                                        @if ($celebrants)
                                                                            @foreach ($celebrants as $celebrant)
                                                                                <li>{{ $celebrant->lastname }}
                                                                                    {{ $celebrant->firstname }}
                                                                                    {{ $celebrant->middlename }},
                                                                                    дата народження:
                                                                                    {{ $celebrant->birthday }}</li>
                                                                            @endforeach
                                                                        @endif
                                                                        </li>
                                                                    </ol>

                                                                    Будь ласка, зайдіть на
                                                                    <a href="{{ 'https://bday.intita.com/login' }}"
                                                                        target="_blank"> платформу,
                                                                    </a>
                                                                    заздалегідь
                                                                    підготуйте привітання та почніть процес вибору
                                                                    подарунка для іменинника (-ів).
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">
                                                                        Гарного дня,
